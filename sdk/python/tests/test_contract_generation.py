...
GENERATED_TARGETS = [
    Path("src/deepseekx/generated/notification_registry.py"),
    Path("src/deepseekx/generated/v2_all.py"),
    Path("src/deepseekx/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("deepseekx-cli-bin") == "0.131.0a4"
    env = os.environ.copy()
    env.pop("DEEPSEEKX_EXEC_PATH", None)
