...
Creates __WE_WORKTREE_ROOT_REL__/<slug>-<agent> on branch
worktree/<slug>/<agent> from origin/main by default.

Environment:
  WE_WORKTREE_ROOT   override worktree parent directory
  WE_WORKTREE_BASE   override base ref, e.g. HEAD or feature/foo
  WE_FEATURE_MAIN    override base branch, default main
...
worktree_root="${WE_WORKTREE_ROOT:-__WE_WORKTREE_ROOT_REL__}"
