...
PACKAGE_EXPANSIONS: dict[str, list[str]] = {
    "deepseekx": ["deepseekx", *CODEX_PLATFORM_PACKAGES],
}

PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    "deepseekx": [],
    "deepseekx-linux-x64": ["bwrap", "deepseekx", "rg"],
    "deepseekx-linux-arm64": ["bwrap", "deepseekx", "rg"],
    "deepseekx-darwin-x64": ["deepseekx", "rg"],
    "deepseekx-darwin-arm64": ["deepseekx", "rg"],
    "deepseekx-win32-x64": [
        "deepseekx",
        "rg",
...
COMPONENT_DEST_DIR: dict[str, str] = {
    ...
    "deepseekx": "deepseekx",
    "codex-responses-api-proxy": "codex-responses-api-proxy",
    "codex-windows-sandbox-setup": "deepseekx",
    "codex-command-runner": "deepseekx",
    "rg": "path",
}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="deepseekx",
        help="Which npm package to stage (default: deepseekx).",
    )
    parser.add_argument(
        "--version",
...
def main() -> int:
    ...
    try:
        ...
        if release_version:
            ...
            if package == "deepseekx":
                print(
                    f"Staged version {version} for release in {staging_dir_str}\n\n"
                    "Verify the CLI:\n"
                    f"    node {staging_dir_str}/bin/deepseekx.js --version\n"
                    f"    node {staging_dir_str}/bin/deepseekx.js --help\n\n"
                )
...
def prepare_staging_dir(staging_dir: Path | None) -> tuple[Path, bool]:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="deepseekx-npm-stage-"))
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "deepseekx":
        ...
        shutil.copy2(
            CODEX_CLI_ROOT / "bin" / "deepseekx.js",
            bin_dir / "deepseekx.js",
        )
    ...
    if package == "deepseekx":
        ...
        package_json["optionalDependencies"] = {
            ...
            for platform_package in PACKAGE_EXPANSIONS["deepseekx"]
            if platform_package != "deepseekx"
        }
...
def run_npm_pack(staging_dir: Path, output_path: Path) -> Path:
    ...
    with tempfile.TemporaryDirectory(prefix="deepseekx-npm-pack-") as pack_dir_str:
