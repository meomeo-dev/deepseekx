#!/usr/bin/env node
// Unified entry point for the DeepSeekX CLI.
...
const deepseekxBinaryName = process.platform === "win32" ? "deepseekx.exe" : "deepseekx";
...
const binaryPath = path.join(archRoot, "deepseekx", deepseekxBinaryName);
...
/**
 * Use heuristics to detect the package manager that installed DeepSeekX
...
const packageManagerEnvVar =
  detectPackageManager() === "bun"
    ? "DEEPSEEKX_MANAGED_BY_BUN"
    : "DEEPSEEKX_MANAGED_BY_NPM";
