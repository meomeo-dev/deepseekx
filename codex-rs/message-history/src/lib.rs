...
//!
//! The history is stored at `~/.deepseekx/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.deepseekx`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.deepseekx/history.jsonl` and ensure the parent directory exists.
