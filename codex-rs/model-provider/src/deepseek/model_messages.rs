...
// Seeded from GPT-5.4-family Codex instruction metadata and copied into the
// DeepSeek provider so future DeepSeek-specific adaptation stays local.
pub(super) fn deepseek_v4_pro_base_instructions() -> String {
    PRO_BASE_INSTRUCTIONS.to_string()
}

pub(super) fn deepseek_v4_flash_base_instructions() -> String {
    FLASH_BASE_INSTRUCTIONS.to_string()
}

pub(super) fn deepseek_v4_pro_model_messages() -> ModelMessages {
    model_messages(
        PRO_INSTRUCTIONS_TEMPLATE,
        PRO_PERSONALITY_DEFAULT,
        PRO_PERSONALITY_FRIENDLY,
        PRO_PERSONALITY_PRAGMATIC,
    )
}

pub(super) fn deepseek_v4_flash_model_messages() -> ModelMessages {
    model_messages(
        FLASH_INSTRUCTIONS_TEMPLATE,
        FLASH_PERSONALITY_DEFAULT,
        FLASH_PERSONALITY_FRIENDLY,
        FLASH_PERSONALITY_PRAGMATIC,
    )
}

fn model_messages(
    instructions_template: &str,
    personality_default: &str,
    personality_friendly: &str,
    personality_pragmatic: &str,
) -> ModelMessages {
    ModelMessages {
        instructions_template: Some(instructions_template.to_string()),
        instructions_variables: Some(ModelInstructionsVariables {
            personality_default: Some(personality_default.to_string()),
...
const PRO_BASE_INSTRUCTIONS: &str = r###"You are Codex, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.
...
const PRO_INSTRUCTIONS_TEMPLATE: &str = r###"You are Codex, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.
...
const PRO_PERSONALITY_DEFAULT: &str = r###""###;

const PRO_PERSONALITY_FRIENDLY: &str = r###"# Personality
...
const PRO_PERSONALITY_PRAGMATIC: &str = r###"# Personality
...
const FLASH_BASE_INSTRUCTIONS: &str = r###"You are Codex, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.
...
const FLASH_INSTRUCTIONS_TEMPLATE: &str = r###"You are Codex, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.
...
const FLASH_PERSONALITY_DEFAULT: &str = r###""###;

const FLASH_PERSONALITY_FRIENDLY: &str = r###"# Personality
...
const FLASH_PERSONALITY_PRAGMATIC: &str = r###"# Personality
