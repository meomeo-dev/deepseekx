...
pub(super) fn deepseek_model_messages() -> ModelMessages {
    ModelMessages {
...
const BASE_INSTRUCTIONS: &str = r###"You are Codex, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.
...
const INSTRUCTIONS_TEMPLATE: &str = r###"You are Codex, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.
...
const PERSONALITY_DEFAULT: &str = r###""###;

const PERSONALITY_FRIENDLY: &str = r###"# Personality
...
const PERSONALITY_PRAGMATIC: &str = r###"# Personality
