...
#[derive(Debug, Parser)]
#[command(bin_name = "deepseekx plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "deepseekx plugin marketplace add")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "deepseekx plugin marketplace upgrade")]
struct UpgradeMarketplaceArgs {
    marketplace_name: Option<String>,
}

#[derive(Debug, Parser)]
#[command(bin_name = "deepseekx plugin marketplace remove")]
