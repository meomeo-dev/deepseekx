...
const BASE_CLI_BUG_ISSUE_URL: &str =
    "https://github.com/meomeo-dev/deepseekx/issues/new?template=3-cli.yml";
        ...
        items: vec![
            super::SelectionItem {
                ...
                description: Some(format!(
                    "Share the current {PRODUCT_NAME} session logs with the team for troubleshooting."
                )),
...
mod tests {
    ...
    fn issue_url_available_for_bug_bad_result_safety_check_and_other() {
        ...
        let expected_external_url = "https://github.com/meomeo-dev/deepseekx/issues/new?template=3-cli.yml&steps=Uploaded%20thread:%20t";
